...
class StringSchema extends Schema {
  ...
  matches (reg, options = {}) {
    ...
    const { message, excludeEmptyString = false, matchRule = true, name = "matches" } = options;
  ...
  required (message, options = []) {
    return super.required(message, [].concat(options, ""));
  }
